    ...
    <div className="h-full flex flex-col">
      ...
      <div className="space-y-4">
        ...
        <AjCard title="INTEGRACIONES" defaultOpen={false}>
          ...
          {/* Solo cuando hay algo que conectar: a quien ya lo tiene, este aviso no
              le dice nada y solo ocupa. */}
          {!profile.gmail_connected && <div className="pb-3"><AvisoGoogle compacto/></div>}
