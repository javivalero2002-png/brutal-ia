...
export { dlDate, dlLabel, strColor, relTime, videoEmbed, todayKey, localDayKey, daysBetweenKeys, estadoDeadline, madridHour, madridDateLabel, plural, mensajeErrorTranscripcion } from './helpers'
