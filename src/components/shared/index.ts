...
export { dlDate, dlLabel, strColor, relTime, videoEmbed, todayKey, localDayKey, daysBetweenKeys, estadoDeadline, madridHour, madridDateLabel, plural, parseImporte, buscaEnTexto, NIVEL_TAREA, rotuloNivel, nivelTarea, mensajeErrorTranscripcion } from './helpers'
